...
.nodevenv.once:
	...
	@echo "  *   C:\Program Files\Microsoft Visual Studio 12.0\Common7\IDE"
	@echo "  * "
	@touch $@
...
ifneq ($(found_devenv),)
Debug_Win32: aom.sln
	$(MSBUILD_TOOL) aom.sln -m -t:Build \
		-p:Configuration="Debug" -p:Platform="Win32"
else
Debug_Win32: aom.sln .nodevenv.once
...
.PHONY: Release_Win32
ifneq ($(found_devenv),)
Release_Win32: aom.sln
	$(MSBUILD_TOOL) aom.sln -m -t:Build \
		-p:Configuration="Release" -p:Platform="Win32"
else
Release_Win32: aom.sln .nodevenv.once
